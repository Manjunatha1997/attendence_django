...
def index(request):
    return  render(request,'secondyear/index.html')
...
def addStudents(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('/secondyear/addStudents/')

    return render(request,'secondyear/addStudents.html',{'form':form})

def show(request):
    all_data = Student.objects.all()
    return render(request,'secondyear/show.html',{'all_data':all_data})

def studentData(request,pk):
    all_data =Attend.objects.filter(rollno=pk)
    return render(request,'secondyear/studentData.html',{'all_data':all_data})
...
def attend(request):
    ...
    return render(request,'secondyear/attend.html',{'all_data':all_data})
...
def attendResult(request):
    ...
    return render(request,'secondyear/attendResult.html',{'all_data':all_data,'result':result})
...
def searchResult(request):
    ...
    return render(request,'secondyear/searchResult.html',{'all_data':all_data})


def delete(request,pk):
    all_data = Attend.objects.filter(id=pk)
    all_data.delete()
    return redirect('/secondyear/attendResult/')


def deleteStudent(request,pk):
    all_data = Student.objects.filter(rollno=pk)
    all_data.delete()
    return redirect('/secondyear/show/')
...
def update(request,pk):
    ...
    for data in al_data:
        if data.status == True:
            ...
            # print(data.status)
            return redirect('/secondyear/attendResult/')
    # return render(request,'secondyear/attendResult.html',{'all_data':all_data})
